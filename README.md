...
Our analysis reveals that counties with existing data centers show notably higher environmental burdens compared to counties without: PM2.5 (+27 percentile points), Diesel PM (+24), NO2 (+22), and RMP Facilities (+27) show the largest differences. Counties slated for projected data center development show an even more pronounced pattern, with Toxic Releases (+33), Hazardous Waste (+30), and Traffic Proximity (+28) among the highest differences. Both existing and projected data center counties also show higher proportions of People of Color (+15-16 percentile points) and Linguistic Isolation (+11-14 percentile points).
